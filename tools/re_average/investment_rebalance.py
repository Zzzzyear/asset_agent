...
# ------------------------ 修改4：生成最终报告图（四子图） ------------------------
def generate_report(data: pd.DataFrame, benchmark_nav: pd.Series, trad_nav: pd.Series, trad_comp: pd.DataFrame,
                    rec_nav: pd.Series = None, rec_comp: pd.DataFrame = None) -> dict:
